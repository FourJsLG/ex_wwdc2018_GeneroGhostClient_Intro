...
FUNCTION ggc_sample_test()
    ...
    WAIT_FOR_APPLICATION("app_2176", 6379)
    
    ASSERT_EQUALS(getFieldValue("formonly.now"), TODAY) --DATE

    FOCUS_FIELD("app_2176", "formonly.op1")

    
    INPUT_FIELD("app_2176", "formonly.op1", "1")
    FOCUS_FIELD("app_2176", "formonly.op2")

    INPUT_FIELD("app_2176", "formonly.op2", "2")
    SEND_ACTION("app_2176", "plus")

    ASSERT_EQUALS(getFieldValue("formonly.result"), "3") --INTEGER
    ASSERT_EQUALS(getFieldValue("formonly.remaind"), "") --INTEGER

    SEND_ACTION("app_2176", "close")

    APPLICATION_ENDED("app_2176", 0)
